...
apps = [
    {
        ...
        'pattern': r'word',
        'position': (0, 0, 960, 540),  # Perfect top-left
    },
    {
        'command': r"C:\xampp\xampp-control.exe",
        'pattern': r'xampp\ control\ panel',
        'position': (950, 0, 980, 547),  # Top-right with offset
    },
    {
        'command': r"C:\Windows\system32\mspaint.exe",
        'pattern': r'paint',
        'position': (-8, 538, 973, 547),  # Bottom-left with offset
    },
    {
        'command': r"C:\Users\Florian\AppData\Roaming\Zoom\bin\Zoom.exe",
        'pattern': r'zoom\ workplace',
        'position': (950, 538, 980, 547),  # Bottom-right with offset
    },
]
